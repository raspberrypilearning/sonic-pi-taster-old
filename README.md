...
1. Complete the Frere Jacque song by using the table to translate musical notes into Sonic Pi note values.
...
2. Create your own tune using what you have learned so far.
